...
namespace Tourmaline.Viewer3D.Common
{
    public static class Helpers
    {
        ...
        public static string GetForestTextureFile(MicroSim microSim, string textureName)
        {
            return GetRouteTextureFile(microSim, Helpers.TextureFlags.Spring | Helpers.TextureFlags.Autumn | Helpers.TextureFlags.Winter | Helpers.TextureFlags.SpringSnow | Helpers.TextureFlags.AutumnSnow | Helpers.TextureFlags.WinterSnow, textureName);
        }

        public static string GetNightTextureFile(MicroSim microSim, string textureFilePath)
        {
        ...
        public static string GetRouteTextureFile(MicroSim microSim, TextureFlags textureFlags, string textureName)
        {
            return GetTextureFile(microSim, textureFlags, microSim.contentPath + @"\Textures", textureName);
        }

        public static string GetTransferTextureFile(MicroSim microSim, string textureName)
        {
            return GetTextureFile(microSim, Helpers.TextureFlags.Snow, microSim.contentPath + @"\Textures", textureName);
        }

        public static string GetTerrainTextureFile(MicroSim microSim, string textureName)
        {
            return GetTextureFile(microSim, Helpers.TextureFlags.Snow, microSim.contentPath + @"\TerrTex", textureName);
        }

        public static string GetTextureFile(MicroSim microSim, TextureFlags textureFlags, string texturePath, string textureName)
        {
            var alternativePath = @"\";
