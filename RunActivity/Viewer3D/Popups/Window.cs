...
namespace Tourmaline.Viewer3D.Popups
{
    ...
    {
        const int BaseFontSize = 64; // DO NOT CHANGE without also changing the graphics for the windows.
        ...
        public virtual void PrepareFrame(RenderFrame frame, long elapsedTime, bool updateFull)
        {
            if (Visible)
        ...
        [CallOnThread("Updater")]
        public virtual void PrepareFrame(long elapsedTime, bool updateFull)
        {
        }
