...
namespace Tourmaline.Viewer3D.Popups
{
    public class WindowManager : RenderPrimitive
    {
        ...
        public readonly WindowTextFont TextFontBig;
        ...
        private long mvarMillisCumul; //Milisegundos acumulados entre esta y la anterior actualización completa
        private const long WINDOW_FULL_UPDATE = 250; //250 milisegundos entre actualizaciones
        ...
        public WindowManager(Viewer viewer)
        {
            ...
            TextFontDefault = TextManager.GetScaled("Arial", 32, System.Drawing.FontStyle.Regular);
            TextFontDefaultBold = TextManager.GetScaled("Arial", 32, System.Drawing.FontStyle.Bold);
            TextFontDefaultOutlined = TextManager.GetScaled("Arial", 32, System.Drawing.FontStyle.Regular, 1);
            ...
            TextFontBig = TextManager.GetScaled("Arial", 18, System.Drawing.FontStyle.Regular, 2);
            ...
            if (ScrollbarTexture == null)
                ...
                ScrollbarTexture = SharedTextureManager.Get(Viewer.RenderProcess.GraphicsDevice, System.IO.Path.Combine(Viewer.ResourcesPath, "WindowScrollbar.png"));
            if (LabelShadowTexture == null)
                // TODO: This should happen on the loader thread.
                LabelShadowTexture = SharedTextureManager.Get(Viewer.RenderProcess.GraphicsDevice, System.IO.Path.Combine(Viewer.ResourcesPath, "WindowLabelShadow.png"));
        ...
        long LastPrepareRealTime=0;
        [CallOnThread("Updater")]
        public void PrepareFrame(RenderFrame frame, long elapsedTime)
        {
            mvarMillisCumul += elapsedTime;
            var updateFull = false;
            if (mvarMillisCumul> WINDOW_FULL_UPDATE)
            {
                mvarMillisCumul %= WINDOW_FULL_UPDATE;
                updateFull = true;
            }                       
        ...
        public override void Draw(GraphicsDevice graphicsDevice)
        {
            ...
            foreach (var window in VisibleWindows)
            {
                ...
                //bool windowGlass = Viewer.Settings.WindowGlass;
                bool windowGlass = true;
                if (windowGlass)
                {
        ...
        [CallOnThread("Updater")]
        public void HandleUserInput(TimeSpan elapsedTime)
        {
            /*
