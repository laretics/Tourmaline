...
namespace Tourmaline.Viewer3D
{
    ...
    public class SceneryShader : Shader
    {
        ...
        public void SetMatrix(Matrix w, ref Matrix vp)
        {
            ...
            int vIn = 1; //TODO: Revertir esto cuando tenga un objeto "simulador"
    ...
    public class SkyShader : Shader
    {
        ...
        {
            //int vIn = Program.Simulator.Settings.DayAmbientLight;
            int vIn = 4; //TODO: Cambiar esto. Lo hice para que compilase.
    ...
    public class PopupWindowShader : Shader
    {
            ...
            : base(graphicsDevice, "PopupWindow")
        {
            ...
            Parameters["WindowTexture"].SetValue(SharedTextureManager.Get(graphicsDevice, System.IO.Path.Combine(viewer.ResourcesPath, "Window.png")));
        }
    }
