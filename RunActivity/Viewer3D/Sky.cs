...
namespace Tourmaline.Viewer3D
{
    ...
    public class SkyViewer
    {
        ...
        public void PrepareFrame(RenderFrame frame, TimeSpan elapsedTime)
        {
            ...
            if (worldLoc == null)
            {
                ...
                //int auxSeason = (int)Viewer.Simulator.Season;
                int auxSeason = 1;
                if (seasonType != auxSeason)
                {
                    seasonType = auxSeason;
            ...
            while (ahora >= (oldClockTime + 1200)) // Plus key, or normal forward in time; <CSComment> better so in case of fast forward
            {
            ...
            if (ahora <= (oldClockTime - 1200)) // Minus key
            {
                oldClockTime = ahora;
                diff = 0;
                step1--;
        ...
        private float GetCelestialDiff()
        {
            //double ahora = Viewer.Simulator.ClockTime;
            double ahora = 0;
            var diffS = (ahora - oldClockTime);
            //TODO: Descomentar esta línea cuando sepa qué es lo que hace.
    ...
    public class SkyMaterial : Material
    {
        ...
        public override void Render(GraphicsDevice graphicsDevice, IEnumerable<RenderItem> renderItems, ref Matrix XNAViewMatrix, ref Matrix XNAProjectionMatrix)
        {
            ...
            SkyShader.StarMapTexture = StarTextureN; //He anulado el bloque anterior para no tener que calcular en base a un escenario
