namespace TOURMALINE.Common.Input
{
    /// <summary>
    /// Especificación de comandos del juego.
    /// </summary>
    /// <remarks>
    /// <para>El orden y los nombres de estos comandos son importantes. Se muestran en el interface de usuaqrio en el orden en que se definieron en el código y la primera palabra de caa uno es el "grupo" al que pertenece.</para>
    /// </remarks>
