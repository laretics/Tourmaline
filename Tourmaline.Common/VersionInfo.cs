...
{
    /// <summary>
    /// Clase estática que proporciona información de la versión y el ensamblado de todo el código del juego.
    /// </summary>
    public static class VersionInfo
    {
        ...
        public static readonly string Version = GetVersion("Tourmaline.exe");

        /// <summary>Full build, e.g. "0.0.5223.24629 (2014-04-20 13:40:58Z)"</summary>
        public static readonly string Build = GetBuild("Tourmaline.exe");
