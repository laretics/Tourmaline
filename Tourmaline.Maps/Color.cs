...
namespace ACadSharp
{
	public readonly struct Color : IEquatable<Color>
	{
		...
		public static byte[] GetIndexRGB(byte index)
		{
			return _indexRgb[index];
		}
		...
		private static byte[] getRGBfromTrueColor(uint color)
		{
			return LittleEndianConverter.Instance.GetBytes(color);
		}
	}
}
