...
namespace ACadSharp.IO.DXF
{
    internal class DxfObjectsSectionWriter : DxfSectionWriterBase
    {
        ...
        protected void writeObject<T>(T co)
            where T : CadObject
        {
            Type popo = co.GetType();
            if( popo == typeof(AcdbPlaceHolder) || 
                popo == typeof(Material) || 
                popo == typeof(MultiLeaderStyle) || 
                popo == typeof(VisualStyle) || 
                popo == typeof(ImageDefinitionReactor)) 
            {
