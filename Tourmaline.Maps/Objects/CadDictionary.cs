...
namespace ACadSharp.Objects
{
    ...
    public class CadDictionary : NonGraphicalObject, IObservableCollection<NonGraphicalObject>
    {
        ...
        private readonly Dictionary<string, NonGraphicalObject> _entries = new Dictionary<string, NonGraphicalObject>(StringComparer.OrdinalIgnoreCase);
        ...
        public CadObject Remove(string key)
        {
            ...
            {
                NonGraphicalObject popo = this._entries[key];
                popo.Owner = null;
                this._entries.Remove(key);
                OnRemove?.Invoke (this, new CollectionChangedEventArgs(popo));
                return popo;
            }
            return null;
        }
